...
/**
 * This GUI class is used to convert the image to sepia toned image.
 */
public class Sepia implements GUIImageCommands {
  private final IView view;

  /**
   * This is the constructor of Sepia class.
   */
  public Sepia(IView view) {
    this.view = view;
  }
