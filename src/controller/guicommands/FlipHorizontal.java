...
/**
 * This GUI class is used to flip the image horizontally.
 */
public class FlipHorizontal implements GUIImageCommands {
   ...
   */
  public FlipHorizontal(IView view) {
    this.view = view;
  }
