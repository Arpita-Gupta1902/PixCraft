...
/**
 * This GUI class is used to get the green component of the image.
 */
public class GreenComponent implements GUIImageCommands {
   ...
   */
  public GreenComponent(IView view) {
    this.view = view;
  }
