...
/**
 * This GUI class is used to flip the image vertically.
 */
public class FlipVertical implements GUIImageCommands {
   ...
   */
  public FlipVertical(IView view) {
    this.view = view;
  }
