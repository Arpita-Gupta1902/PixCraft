...
/**
 * This GUI class is used to convert the image to a Luma grayscale image.
 */
public class LumaComponent implements GUIImageCommands {
  private final IView view;

  /**
   * This is the constructor of LumaComponent class.
   */
  public LumaComponent(IView view) {
    this.view = view;
  }
  ...
  public void execute(ImageModel model) {
    ...
    model.convertLumaGrayScale("1", "2");
