...
/**
 * This GUI class is used to get the red component of the image.
 */
public class RedComponent implements GUIImageCommands {
  private final IView view;

  /**
   * This is the constructor of RedComponent class.
   */
  public RedComponent(IView view) {
    this.view = view;
  }
