...
/**
 * This GUI class is used to save an image by converting it to a buffered image.
 */
public class Save implements GUIImageCommands {
  ...
  public void execute(ImageModel model) throws IOException {
    String selectedFilePath = view.saveDialogBox();
    writeImage(model.saveImage("2"), selectedFilePath);
  }
