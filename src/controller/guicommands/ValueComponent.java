...
/**
 * This GUI class converts the image to a value grayscale image.
 */
public class ValueComponent implements GUIImageCommands {
  private final IView view;

  /**
   * This is the constructor of ValueComponent class.
   */
  public ValueComponent(IView view) {
    this.view = view;
  }
  ...
  public void execute(ImageModel model) {
    ...
    model.convertValueGrayScale("1", "2");
